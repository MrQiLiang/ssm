          ...
          <!--  <li class="grey">
            ...
            <li class="green">
                ...
                <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                    ...
                    <li>
                        <a href="#">
                            <img src="${ctx}/resources/aceAdmin/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
                            <span class="msg-body">
                    ...
                    <li>
                        <a href="#">
                            <img src="${ctx}/resources/aceAdmin/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
                            <span class="msg-body">
											<span class="msg-title">
                    ...
                    <li>
                        <a href="#">
                            <img src="${ctx}/resources/aceAdmin/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                            <span class="msg-body">
											<span class="msg-title">
            ...
            <li class="light-blue">
                <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                    ...
                    <img class="nav-user-photo"  id = "userImage" onerror="userImageError(this)" src="${ctx}/loadFile/<shiro:user><shiro:principal property="imgUrl"/></shiro:user>" alt="Jason's Photo"  />
   ...
   function setPass() {
       ...
       layer.open({
            ...
            btn1:function (index,layero) {
                ...
                obj.newPass = $("#newPass").val();
                if($("#newPass").val()!=$("#twoNewPass").val()){
                    layer.tips('两次密码不一致','#twoNewPass');
                    return ;
                }
                if(obj.oldPass==null||obj.oldPass==""){
                    layer.tips('旧密码不能为空','#oldPass');
                    return ;
                }
                if(obj.newPass==null||obj.newPass==""){
